                ...
                <table border="0" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($votoDAO->listaPorPergunta($perguntaBanco->getId_pergunta()) as $item) {
                            $dd = $votoDAO->listaPorPergunta($perguntaBanco->getId_pergunta())[$contTexto]->getTexto();
                            if (!empty($dd)) {
                                ?>
                                <tr>
                                    <td><?php echo $votoDAO->listaPorPergunta($perguntaBanco->getId_pergunta())[$contTexto]->getTexto(); ?></td>   
                                </tr>
                                <?php
                                $contTexto++;
                            }
